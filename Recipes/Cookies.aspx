...
<asp:Content ID="c3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="recipes-wrapper">
        ...
        <div style="max-width:900px; margin:20px auto 30px auto; background-color:white; padding:18px; border-radius:12px; box-shadow:0 4px 10px lightgray; text-align:center; color:dimgray;">
            בעמוד זה תוכלו למצוא מתכונים לעוגיות אהובות, עם מרכיבים ואופן הכנה ברור.
        </div>

        <div class="recipe-box">
            <img src="/picture/amsterdam_cookies.jpg" class="recipe-img" alt="עוגיות אמסטרדם קלאסיות" />
        ...
        <div class="recipe-box">
            <img src="/picture/choc_chip_cookies.jpg" class="recipe-img" alt="עוגיות שוקולד צ'יפס קלאסיות" />
        ...
        <div class="recipe-box">
            <img src="/picture/tahini_cookies.jpg" class="recipe-img" alt="עוגיות טחינה ביתיות" />
